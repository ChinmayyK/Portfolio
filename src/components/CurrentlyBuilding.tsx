            ...
            <div className="flex-1 flex flex-col gap-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  <a href="https://github.com/ChinmayyK/Deskdrop/releases/tag/v0.1.7" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-[var(--surface-soft)] border border-[var(--line)] text-xs font-semibold text-[var(--text)] hover:bg-[var(--surface-muted)] transition-all hover:scale-105 active:scale-95 shadow-sm hover:border-[var(--teal)]/40 hover:text-[var(--teal)]">
                  ...
                  <a href="https://github.com/ChinmayyK/Deskdrop/releases/download/v0.1.7/app-release.apk" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-[var(--surface-soft)] border border-[var(--line)] text-xs font-semibold text-[var(--text)] hover:bg-[var(--surface-muted)] transition-all hover:scale-105 active:scale-95 shadow-sm hover:border-[var(--teal)]/40 hover:text-[var(--teal)]">
