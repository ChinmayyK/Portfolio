              ...
              <div>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    <a href="https://github.com/ChinmayyK/Deskdrop/releases/download/v1.1.1/Deskdrop.dmg" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-4 py-3.5 rounded-xl bg-[var(--surface-soft)] border border-[var(--line)] text-sm font-semibold text-[var(--text)] hover:bg-[var(--surface-muted)] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:border-[var(--teal)]/40 hover:text-[var(--teal)] group">
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--surface-muted)] border border-[var(--line)] group-hover:border-[var(--teal)]/30 group-hover:text-[var(--teal)] transition-colors">
                        ...
                        <div className="flex flex-col items-start gap-0.5">
                          <span>macOS</span>
                          <span className="font-mono text-[9px] uppercase tracking-wider text-[var(--soft)] group-hover:text-[var(--teal)]/70 transition-colors">Apple Silicon & Intel</span>
                        </div>
                      </div>
                      <svg className="w-4 h-4 text-[var(--soft)] group-hover:text-[var(--teal)] transition-colors opacity-50 group-hover:opacity-100" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    </a>
                    <a href="https://github.com/ChinmayyK/Deskdrop/releases/download/v1.1.1/Deskdrop.exe" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-4 py-3.5 rounded-xl bg-[var(--surface-soft)] border border-[var(--line)] text-sm font-semibold text-[var(--text)] hover:bg-[var(--surface-muted)] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:border-[var(--teal)]/40 hover:text-[var(--teal)] group">
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--surface-muted)] border border-[var(--line)] group-hover:border-[var(--teal)]/30 group-hover:text-[var(--teal)] transition-colors">
                          <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M0 3.449L9.75 2.1v9.451H0V3.449zM0 12.45h9.75v9.45L0 20.551v-8.101zM10.95 1.939L24 0v11.6 h-13.05V1.939zM24 12.45v11.55l-13.05-1.8v-9.75H24z"/></svg>
                        </div>
                        <div className="flex flex-col items-start gap-0.5">
                          <span>Windows</span>
                          <span className="font-mono text-[9px] uppercase tracking-wider text-[var(--soft)] group-hover:text-[var(--teal)]/70 transition-colors">Windows 10 / 11</span>
                        </div>
                      </div>
                      <svg className="w-4 h-4 text-[var(--soft)] group-hover:text-[var(--teal)] transition-colors opacity-50 group-hover:opacity-100" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    </a>
                    <a href="https://github.com/ChinmayyK/Deskdrop/releases/download/v1.1.1/app-release.apk" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-4 py-3.5 rounded-xl bg-[var(--surface-soft)] border border-[var(--line)] text-sm font-semibold text-[var(--text)] hover:bg-[var(--surface-muted)] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:border-[var(--teal)]/40 hover:text-[var(--teal)] group">
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--surface-muted)] border border-[var(--line)] group-hover:border-[var(--teal)]/30 group-hover:text-[var(--teal)] transition-colors">
                          <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M6 18c0 .55.45 1 1 1h1v3c0 .55.45 1 1 1s1-.45 1-1v-3h2v3c0 .55.45 1 1 1s1-.45 1-1v-3h1c.55 0 1-.45 1-1V8H6v10zM12 2C9.24 2 7 4.24 7 7h10c0-2.76-2.24-5-5-5zM2 8c-.55 0-1 .45-1 1v7c0 .55.45 1 1 1s1-.45 1-1V9c0-.55-.45-1-1-1zm20 0c-.55 0-1 .45-1 1v7c0 .55.45 1 1 1s1-.45 1-1V9c0-.55-.45-1-1-1z"/></svg>
                        </div>
                        <div className="flex flex-col items-start gap-0.5">
                          <span>Android</span>
                          <span className="font-mono text-[9px] uppercase tracking-wider text-[var(--soft)] group-hover:text-[var(--teal)]/70 transition-colors">Android 8.0+</span>
                        </div>
                      </div>
                      <svg className="w-4 h-4 text-[var(--soft)] group-hover:text-[var(--teal)] transition-colors opacity-50 group-hover:opacity-100" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    </a>
